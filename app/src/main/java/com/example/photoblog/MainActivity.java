...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String UPLOAD_URL = "http://10.0.2.2:8000/post/new";
    Uri imageUri = null;
    ...
    private String uploadImage(String imageUrl) throws IOException, JSONException {
        ...
        try {
            try {
                ...
                jsonObject.put("text", "안드로이드로 작성된RESTAPI테스트 입력 입니다.");
                jsonObject.put("created_date", "2024-06-03T18:34:00+09:00");
                jsonObject.put("published_date", "2024-06-03T18:34:00+09:00"); //jsonObject.put("image", imageUrl);
